...
urlpatterns = (
    [
        ...
        path(
            "send_feedback_to_all_students",
            HodViews.send_feedback_to_all_students,
            name="send_feedback_to_all_students",
        ),
        path(
            "send_feedback_to_all_staff",
            HodViews.send_feedback_to_all_staff,
            name="send_feedback_to_all_staff",
        ),
        #     Staff URL Path
        ...
        path(
            "student_send_staff_feedback",
            StudentViews.student_send_staff_feedback,
            name="student_send_staff_feedback",
        ),
        path(
            "student_send_staff_feedback_save",
            StudentViews.student_send_staff_feedback_save,
            name="student_send_staff_feedback_save",
        ),
        path(
            "staff_view_student_feedback",
            StaffViews.staff_view_student_feedback,
            name="staff_view_student_feedback",
        ),
        path(
            "staff_reply_student_feedback",
            StaffViews.staff_reply_student_feedback,
            name="staff_reply_student_feedback",
        ),
        path(
