...
class LeaveReportStudent(models.Model):
    ...
    leave_type = models.CharField(max_length=50, choices=LEAVE_TYPES, default="Casual Leave")
...
class LeaveReportStaff(models.Model):
    LEAVE_TYPES = [
        ...
        ("Half Day", "Half Day"),
        ("Work From Home", "Work From Home"),
        ("Conference Leave", "Conference Leave"),
...
class FeedBackStudent(models.Model):
    ...
    feedback_reply = models.TextField(default="", blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now_add=True)
    objects = models.Manager()


class StudentToStaffFeedback(models.Model):
    id = models.AutoField(primary_key=True)
    student_id = models.ForeignKey(Students, on_delete=models.CASCADE)
    staff_id = models.ForeignKey(Staffs, on_delete=models.CASCADE)
    feedback = models.TextField()
